...
<head>
  ...
  <link rel="shortcut icon" href="animate/assets/favicon.ico" type="image/x-icon" />
...
<body id="pmotion" draggable="false" class="loading">
  ...
  <div id="toolbar" class="noselect">
    <div id="logo">
      <a href="#">
        <img src="animate/assets/logo.png" alt="Euforia">
      </a>
    </div>
    <div id="tool-wrap">
        ...
        <div class="tool-content">
          ...
          <div class="nav-tab-wrap">
            ...
            <div id="project-library" class="nav-tab-content">
              <div id="template-library" class="css-grid">
                <div class="image-grid-item" data-template="animate/files/templates/1.json" title="Template 1">
                  <div class="img-wrap">
                    <div class="img-loader"></div>
                    <img class="lazy" src="animate/files/templates/1.png" alt="" draggable="false" />
                  </div>
                </div>
                <div class="image-grid-item" data-template="animate/files/templates/2.json" title="Template 2">
                  <div class="img-wrap">
                    <div class="img-loader"></div>
                    <img class="lazy" src="animate/files/templates/2.png" alt="" draggable="false" />
                  </div>
                </div>
                <div class="image-grid-item" data-template="animate/files/templates/3.json" title="Template 3">
                  <div class="img-wrap">
                    <div class="img-loader"></div>
                    <img class="lazy" src="animate/files/templates/3.png" alt="" draggable="false" />
                  </div>
                </div>
                <div class="image-grid-item" data-template="animate/files/templates/4.json" title="Template 4">
                  <div class="img-wrap">
                    <div class="img-loader"></div>
                    <img class="lazy" src="animate/files/templates/4.png" alt="" draggable="false" />
                  </div>
                </div>
                <div class="image-grid-item" data-template="animate/files/templates/5.json" title="Template 5">
                  <div class="img-wrap">
                    <div class="img-loader"></div>
                    <img class="lazy" src="animate/files/templates/5.png" alt="" draggable="false" />
                  </div>
                </div>
                <div class="image-grid-item" data-template="animate/files/templates/6.json" title="Template 6">
                  <div class="img-wrap">
                    <div class="img-loader"></div>
                    <img class="lazy" src="animate/files/templates/6.png" alt="" draggable="false" />
                  </div>
                </div>
                <div class="image-grid-item" data-template="animate/files/templates/7.json" title="Template 7">
                  <div class="img-wrap">
                    <div class="img-loader"></div>
                    <img class="lazy" src="animate/files/templates/7.png" alt="" draggable="false" />
                  </div>
                </div>
                <div class="image-grid-item" data-template="animate/files/templates/8.json" title="Template 8">
                  <div class="img-wrap">
                    <div class="img-loader"></div>
                    <img class="lazy" src="animate/files/templates/8.png" alt="" draggable="false" />
                  </div>
                </div>
                <div class="image-grid-item" data-template="animate/files/templates/9.json" title="Template 9">
                  <div class="img-wrap">
                    <div class="img-loader"></div>
                    <img class="lazy" src="animate/files/templates/9.png" alt="" draggable="false" />
                  </div>
                </div>
                <div class="image-grid-item" data-template="animate/files/templates/10.json" title="Template 10">
                  <div class="img-wrap">
                    <div class="img-loader"></div>
                    <img class="lazy" src="animate/files/templates/10.png" alt="" draggable="false" />
                  </div>
                </div>
                <div class="image-grid-item" data-template="animate/files/templates/11.json" title="Template 11">
                  <div class="img-wrap">
                    <div class="img-loader"></div>
                    <img class="lazy" src="animate/files/templates/11.png" alt="" draggable="false" />
                  </div>
                </div>
                <div class="image-grid-item" data-template="animate/files/templates/12.json" title="Template 12">
                  <div class="img-wrap">
                    <div class="img-loader"></div>
                    <img class="lazy" src="animate/files/templates/12.png" alt="" draggable="false" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="shapes-cont">
            ...
            <div class="animated-text-grid">
              <div class="animated-text-item noselect" data-id="fade in">
                <img draggable="false" class="noselect" src="animate/assets/fade-in.svg">
                <div>Fade In</div>
              </div>
              <div class="animated-text-item noselect" data-id="typewriter">
                <img draggable="false" class="noselect" src="animate/assets/typewriter.svg">
                <div>Typewriter</div>
              </div>
              <div class="animated-text-item noselect" data-id="slide top">
                <img draggable="false" class="noselect" src="animate/assets/slide-top.svg">
                <div>Slide Top</div>
              </div>
              <div class="animated-text-item noselect" data-id="slide bottom">
                <img draggable="false" class="noselect" src="animate/assets/slide-bottom.svg">
                <div>Slide Bottom</div>
              </div>
              <div class="animated-text-item noselect" data-id="slide left">
                <img draggable="false" class="noselect" src="animate/assets/slide-left.svg">
                <div>Slide Left</div>
              </div>
              <div class="animated-text-item noselect" data-id="slide right">
                <img draggable="false" class="noselect" src="animate/assets/slide-right.svg">
                <div>Slide Right</div>
              </div>
              <div class="animated-text-item noselect" data-id="scale">
                <img draggable="false" class="noselect" src="animate/assets/scale.svg">
                <div>Scale</div>
              </div>
              <div class="animated-text-item noselect" data-id="shrink">
                <img draggable="false" class="noselect" src="animate/assets/shrink.svg">
                <div>Shrink</div>
              </div>
            </div>
        ...
        <div class="tool-content">
          ...
          <div class="shapes-cont">
            ...
            <div id="shapes-gallery-row" class="gallery-row">
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/shapes/1.svg" data-file="animate/files/shapes/1.svg" />
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/shapes/2.svg" data-file="animate/files/shapes/2.svg" />
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/shapes/3.svg" data-file="animate/files/shapes/3.svg" />
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/shapes/4.svg" data-file="animate/files/shapes/4.svg" />
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/shapes/5.svg" data-file="animate/files/shapes/5.svg" />
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/shapes/6.svg" data-file="animate/files/shapes/6.svg" />
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/shapes/7.svg" data-file="animate/files/shapes/7.svg" />
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/shapes/8.svg" data-file="animate/files/shapes/8.svg" />
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/shapes/9.svg" data-file="animate/files/shapes/9.svg" />
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/shapes/10.svg" data-file="animate/files/shapes/10.svg" />
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/shapes/11.svg" data-file="animate/files/shapes/11.svg" />
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/shapes/12.svg" data-file="animate/files/shapes/12.svg" />
              </div>
            </div>
            <button type="button" class="btn btn-full object-more" data-folder="animate/files/shapes/" data-offset="12" data-count="140">Load More</button>
            <!-- Emojis -->
            <p class="row-title">Emojis</p>
            <div class="gallery-row">
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/emojis/1.svg" data-file="animate/files/emojis/1.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/emojis/2.svg" data-file="animate/files/emojis/2.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/emojis/3.svg" data-file="animate/files/emojis/3.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/emojis/4.svg" data-file="animate/files/emojis/4.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/emojis/5.svg" data-file="animate/files/emojis/5.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/emojis/6.svg" data-file="animate/files/emojis/6.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/emojis/7.svg" data-file="animate/files/emojis/7.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/emojis/8.svg" data-file="animate/files/emojis/8.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/emojis/9.svg" data-file="animate/files/emojis/9.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/emojis/10.svg" data-file="animate/files/emojis/10.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/emojis/11.svg" data-file="animate/files/emojis/11.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/emojis/12.svg" data-file="animate/files/emojis/12.svg"/>
              </div>
            </div>
            <button type="button" class="btn btn-full object-more" data-folder="animate/files/emojis/" data-offset="12" data-count="152">Load More</button>
            <!-- Stickers -->
            <p class="row-title">Others</p>
            <div class="gallery-row">
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/others/1.svg" data-file="animate/files/others/1.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/others/2.svg" data-file="animate/files/others/2.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/others/3.svg" data-file="animate/files/others/3.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/others/4.svg" data-file="animate/files/others/4.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/others/5.svg" data-file="animate/files/others/5.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/others/6.svg" data-file="animate/files/others/6.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/others/7.svg" data-file="animate/files/others/7.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/others/8.svg" data-file="animate/files/others/8.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/others/9.svg" data-file="animate/files/others/9.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/others/10.svg" data-file="animate/files/others/10.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/others/11.svg" data-file="animate/files/others/11.svg"/>
              </div>
              <div class="grid-item">
                <img class="object-svg" draggable="false" src="animate/files/others/12.svg" data-file="animate/files/others/12.svg"/>
              </div>
            </div>
            <button type="button" class="btn btn-full object-more" data-folder="animate/files/others/" data-offset="12" data-count="48">Load More</button>
          </div>
        </div>
      </div>
      <!-- IMAGE TOOL -->
      ...
      <div id="audio-tool" class="d-none">
        <div class="tool-content" class="audio-browser">
          ...
          <div id="audio-list-parent">
            <div id="audio-list">
              <div class="audio-item" data-file="animate/files/audio/stomping-rock.mp3">
                <div class="audio-preview">
                  <span class="material-icons">play_arrow</span>
                </div>
                <img class="audio-thumb" src="animate/files/audio/stomping-rock-thumb.png">
                <div class="audio-info">
                  <div class="audio-info-title">Stomping Rock (Four Shots)</div>
                  <div class="audio-info-duration">1:59</div>
                </div>
              </div>
              <div class="audio-item" data-file="animate/files/audio/everything-feels-new.mp3">
                <div class="audio-preview">
                  <span class="material-icons">play_arrow</span>
                </div>
                <img class="audio-thumb" src="animate/files/audio/everything-feels-new-thumb.png">
                <div class="audio-info">
                  <div class="audio-info-title">Everything Feels New</div>
                  <div class="audio-info-duration">1:06</div>
                </div>
              </div>
              <div class="audio-item" data-file="animate/files/audio/the-podcast-intro.mp3">
                <div class="audio-preview">
                  <span class="material-icons">play_arrow</span>
                </div>
                <img class="audio-thumb" src="animate/files/audio/the-podcast-intro-thumb.png">
                <div class="audio-info">
                  <div class="audio-info-title">The Podcast Intro</div>
                  <div class="audio-info-duration">1:51</div>
                </div>
              </div>
              <div class="audio-item" data-file="animate/files/audio/epic-cinematic-trailer.mp3">
                <div class="audio-preview">
                  <span class="material-icons">play_arrow</span>
                </div>
                <img class="audio-thumb" src="animate/files/audio/epic-cinematic-trailer-thumb.png">
                <div class="audio-info">
                  <div class="audio-info-title">Epic Cinematic Trailer</div>
                  <div class="audio-info-duration">2:27</div>
                </div>
              </div>
              <div class="audio-item" data-file="animate/files/audio/inspirational-background.mp3">
                <div class="audio-preview">
                  <span class="material-icons">play_arrow</span>
                </div>
                <img class="audio-thumb" src="animate/files/audio/inspirational-background-thumb.png">
                <div class="audio-info">
                  <div class="audio-info-title">Inspirational Background</div>
                  <div class="audio-info-duration">2:19</div>
                </div>
              </div>
              <div class="audio-item" data-file="animate/files/audio/tropical-summer-music.mp3">
                <div class="audio-preview">
                  <span class="material-icons">play_arrow</span>
                </div>
                <img class="audio-thumb" src="animate/files/audio/tropical-summer-music-thumb.png">
                <div class="audio-info">
    ...
    <div id="top-canvas-menu">
      ...
      <div id="user-menu" class="user-menu">
        <div class="dropdown-wrap">
            <img alt="avatar" src='animate/assets/avatar.png' /><span class="material-icons">arrow_drop_down</span>
